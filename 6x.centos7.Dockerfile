...
ENV YUM_TO_INSTALL="bash curl gcc-c++ make python libstdc++ gnupg"
ENV YUM_TO_REMOVE="bash curl gcc-c++ make python gnupg"
ENV YUM_DEFAULT_DEPENDENCIES_FOR_YARN_BUILD="python make gcc-c++"
